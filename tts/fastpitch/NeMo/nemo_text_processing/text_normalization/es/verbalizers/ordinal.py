...
import pynini
from NeMo.nemo_text_processing.text_normalization.en.graph_utils import NEMO_NOT_QUOTE, NEMO_SIGMA, NEMO_SPACE, GraphFst
from NeMo.nemo_text_processing.text_normalization.es.graph_utils import shift_number_gender
