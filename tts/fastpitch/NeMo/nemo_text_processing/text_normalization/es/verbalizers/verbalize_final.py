...
from NeMo.nemo_text_processing.text_normalization.en.verbalizers.word import WordFst
from NeMo.nemo_text_processing.text_normalization.es.verbalizers.verbalize import VerbalizeFst
