...
class MeasureFst(GraphFst):
    ...
    def __init__(self, decimal: GraphFst, cardinal: GraphFst, fraction: GraphFst, deterministic: bool):
        ...
        graph_masc |= pynutil.add_weight(
            graph_fraction_masc @ (NEMO_SIGMA + pynini.union("medio", "medi")) + NEMO_WHITE_SPACE + unit_masc, -0.001
        ...
        graph_fem |= pynutil.add_weight(
            graph_fraction_fem @ (NEMO_SIGMA + pynini.union("media", "medie")) + NEMO_WHITE_SPACE + unit_fem, -0.001
        )
