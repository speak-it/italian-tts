...
from NeMo.nemo_text_processing.text_normalization.es.graph_utils import (
    accents,
...
class FractionFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        fraction_stem = pynutil.insert(" esimo")
        ...
        remove_accents = pynini.cdrewrite(
            ...
            pynini.closure(NEMO_NOT_SPACE) + pynini.union("avo", "ava", "esimo", "esima"),
            NEMO_SIGMA,
        )
        ...
        fraction_with_cardinal += (
            delete_space + pynutil.insert(" sopra ") + strip_cardinal_apocope(denominator_cardinal)
        )
        ...
        fraction_default |= (
            ...
            + delete_space
            + insert_space
            + (denominator_plural @ pynini.cross("medi", "medie"))
        )
        fraction_with_one |= (
