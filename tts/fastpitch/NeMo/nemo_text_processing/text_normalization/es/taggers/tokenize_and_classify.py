...
from NeMo.nemo_text_processing.text_normalization.es.taggers.cardinal import CardinalFst
from NeMo.nemo_text_processing.text_normalization.en.taggers.punctuation import PunctuationFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.date import DateFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.decimals import DecimalFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.electronic import ElectronicFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.fraction import FractionFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.measure import MeasureFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.money import MoneyFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.ordinal import OrdinalFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.telephone import TelephoneFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.time import TimeFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.whitelist import WhiteListFst
from NeMo.nemo_text_processing.text_normalization.es.taggers.word import WordFst
