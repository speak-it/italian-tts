...
import pynini
from NeMo.nemo_text_processing.text_normalization.en.graph_utils import NEMO_DIGIT, NEMO_SPACE, GraphFst, delete_extra_space
from NeMo.nemo_text_processing.text_normalization.es.utils import get_abs_path
from pynini.lib import pynutil

#articles = pynini.union("di", "del", "il", "dell'anno")
articles = pynini.union("")
...
class DateFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool):
        ...
        graph_dmy = (
            day
            + pynini.closure(pynutil.delete(" di"))
            + NEMO_SPACE
            + month_name
