...
from NeMo.nemo_text_processing.text_normalization.es.graph_utils import roman_to_int, strip_accent
...
class OrdinalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        graph_tens_component = (
            graph_teens
            | (graph_ties + pynini.closure(pynini.cross(" e ", NEMO_SPACE) + graph_digit, 0, 1))
            | graph_twenties
        )
