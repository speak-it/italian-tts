...
from NeMo.nemo_text_processing.text_normalization.es.graph_utils import cardinal_separator
...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        # Any double digit
        graph_tens = teen
        graph_tens |= ties + (pynutil.delete('0') | (pynutil.insert(" e ") + graph_digit))
        graph_tens |= twenties
        ...
        graph_billion = pynutil.add_weight(pynini.cross("000001", "un bilione"), -0.001)
        graph_billion |= graph_thousands_component_at_least_one_none_zero_digit_no_one + pynutil.insert(" bilioni")
