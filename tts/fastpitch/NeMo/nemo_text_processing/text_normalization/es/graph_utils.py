...
import pynini
from NeMo.nemo_text_processing.text_normalization.en.graph_utils import NEMO_SIGMA, NEMO_SPACE
from NeMo.nemo_text_processing.text_normalization.es import LOCALIZATION
from NeMo.nemo_text_processing.text_normalization.es.utils import get_abs_path, load_labels
