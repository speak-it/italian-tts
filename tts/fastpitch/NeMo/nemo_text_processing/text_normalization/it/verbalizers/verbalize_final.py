...
from fastpitch.NeMo.nemo_text_processing.text_normalization.en.verbalizers.word import WordFst
from fastpitch.NeMo.nemo_text_processing.text_normalization.it.verbalizers.verbalize import VerbalizeFst
