import pynini
from fastpitch.NeMo.nemo_text_processing.text_normalization.en.graph_utils import NEMO_NOT_QUOTE, GraphFst
...
class AbbreviationFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph = pynutil.delete(
            "value: \"") + pynini.closure(NEMO_NOT_QUOTE, 1) + pynutil.delete("\"")
