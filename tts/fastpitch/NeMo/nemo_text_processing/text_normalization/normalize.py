...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            ...
            from NeMo.nemo_text_processing.text_normalization.ru.taggers.tokenize_and_classify import ClassifyFst
            from NeMo.nemo_text_processing.text_normalization.ru.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'de':
            from NeMo.nemo_text_processing.text_normalization.de.taggers.tokenize_and_classify import ClassifyFst
            from NeMo.nemo_text_processing.text_normalization.de.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'es':
            from NeMo.nemo_text_processing.text_normalization.es.taggers.tokenize_and_classify import ClassifyFst
            from NeMo.nemo_text_processing.text_normalization.es.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'it':
            from fastpitch.NeMo.nemo_text_processing.text_normalization.it.taggers.tokenize_and_classify import ClassifyFst
            from fastpitch.NeMo.nemo_text_processing.text_normalization.it.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'zh':
            from NeMo.nemo_text_processing.text_normalization.zh.taggers.tokenize_and_classify import ClassifyFst
            from NeMo.nemo_text_processing.text_normalization.zh.verbalizers.verbalize_final import VerbalizeFinalFst
...
def parse_args():
    ...
    input.add_argument("--text", dest="input_string",
                       help="input string", type=str)
    input.add_argument("--input_file", dest="input_file",
                       help="input file path", type=str)
    parser.add_argument('--output_file', dest="output_file",
                        help="output file path", type=str)
    parser.add_argument("--language", help="language",
                        choices=["en", "de", "es", "zh", "it"], default="en", type=str)
    parser.add_argument(
